...
public class TotalIncomeAdapter extends RecyclerView.Adapter<TotalIncomeAdapter.MyViewHolder> {
    Activity activity;
    ...
    public TotalIncomeAdapter(List<StatusData> moviesList, Activity activity2) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.amount.setText(activity.getResources().getString(R.string.Rs)+ NumberToCurrencyExamples.getAmount(Double.valueOf(moviesList.get(position).ei_amount)));
        holder.name.setText((moviesList.get(position).ei_title));
